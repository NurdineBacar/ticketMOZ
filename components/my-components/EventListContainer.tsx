...
const EventListContainer: React.FC<EventListContainerProps> = ({ events, categories = [] }) => {
  ...
  const genres = categories.length > 0 ? categories : Array.from(new Set(events.map(event => event.genre)));
  ...
  return (
    <div id="events-section" className="bg-white py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-8 text-center">{t('upcomingEvents')}</h2>
